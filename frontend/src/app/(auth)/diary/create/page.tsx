...
export default function DiaryCreatePage() {
    ...
    return (
        <div className="max-w-xl mx-auto p-8">
            <h1 className="text-3xl font-bold mb-6 text-[#00004d]">新しい日記を作成</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* 気分選択 */}
                <div>
                    <label htmlFor="mood" className="block font-semibold mb-2 text-[#00004d]">気分</label>
                    <select
                        id="mood"
                        value={mood ?? ''}
                        onChange={(e) => setMood(Number(e.target.value))}
                        className="w-full p-3 border border-gray-300 rounded bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#00004d] transition"
                        required
                    >
